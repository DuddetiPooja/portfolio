...
function initContactForm() {
    ...
    emailjs.init('abO37XlDGcvVTgHgG');
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const [notificationResponse, autoReplyResponse] = await Promise.all([
                // Email to YOU (poojaduddeti@gmail.com) - notification about new contact
                emailjs.send('service_xbqj14m', 'template_fho6w4f', {
                    name: name,
                    title: message,
                    email: 'poojaduddeti@gmail.com',
                    to_email: 'poojaduddeti@gmail.com'
                }),
                // Auto-reply to the SENDER (email from form) - confirmation email
                emailjs.send('service_xbqj14m', 'template_7k6qxbo', {
                    name: name,
                    title: message,
                    email: email,
                    to_email: email
    ...
    function openMailto(name, email, message) {
        ...
        const mailtoLink = `mailto:poojaduddeti@gmail.com?subject=${subject}&body=${body}`;
